...
public class RealStateAppSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("CREATE TABLE RealStateDBTable (_id INTEGER PRIMARY KEY AUTOINCREMENT, Image_resource_id TEXT, title TEXT, description TEXT, latitude DOUBLE, longitude DOUBLE)");
        insertIntoDB(sqLiteDatabase, R.drawable.home1, "in Main Street", "2 bedrooms\n 2 baths \n 1 kitchen", 32.623751, 51.635776);
        insertIntoDB(sqLiteDatabase, R.drawable.home2, "Oak Wood Avenue", "very healthy environment\n very nice neighbours\n 2 beds 1 kitchen", 32.644682, 52.653069);
    ...
    public void insertIntoDB(SQLiteDatabase db, int image, String title, String description, Double latitude, Double longitude){
